...
#../../device/board/orangepi/orangepi_5b/kernel/build_kernel.sh ../../kernel/linux/linux-5.10 /homeB/minjie.yu/openharmony/OpenHarmony-4.1-Release/out/orangepi_5b/packages/phone/images /homeB/minjie.yu/openharmony/OpenHarmony-4.1-Release/device/board/orangepi/orangepi_5b vendor/orangepi/orangepi_5b /homeB/minjie.yu/openharmony/OpenHarmony-4.1-Release orangepi orangepi_5b orangepi root default disable_lto_O0 enable_ramdisk
...
KERNEL_PATCH_PATH=${ROOT_DIR}/device/board/orangepi/orangepi_5b/kernel/patch
KERNEL_PATCH=${ROOT_DIR}/device/board/orangepi/orangepi_5b/kernel/patch/kernel.patch
BUILD_SCRIPT_PATH=${3}
...
DEVICE_CONFIG_PATH=${ROOT_DIR}/device/board/orangepi/orangepi_5b/kernel/config
...
DEFCONFIG_ARCH_FILE=${DEVICE_CONFIG_PATH}/arm64_defconfig
DEFCONFIG_PROC_FILE=${DEVICE_CONFIG_PATH}/rk3588s_standard_defconfig
...
function copy_and_patch_kernel_source()
{
    ...
    cp -rf ${BUILD_SCRIPT_PATH}/kernel/make*.sh ${KERNEL_SRC_TMP_PATH}/

    cp -rf ${BUILD_SCRIPT_PATH}/kernel/drivers/dts/* ${KERNEL_SRC_TMP_PATH}/arch/arm64/boot/dts/rockchip
...
eval $MAKE_OHOS_ENV ./make-ohos.sh ORANGEPI-5B enable_ramdisk
